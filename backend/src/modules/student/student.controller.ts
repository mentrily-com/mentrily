...
import { SubmitUnitDto } from './dto/submit-unit.dto';
...
export class StudentController {
  ...
  @Get('course/:slug/exam-status')
  async getCourseExamStatus(@User() user: any, @Param('slug') slug: string) {
    return this.studentService.getCourseExamStatus(user.id, slug);
  }

  @Get('upcoming-exams')
  async getUpcomingExams(@User() user: any) {
    return this.studentService.getUpcomingExams(user);
  }
