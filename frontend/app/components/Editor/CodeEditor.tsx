...
export default function CodeEditor(props: CodeEditorProps) {
    ...
    return (
        ...
        >
            ...
            <div ref={editorRef} className="flex-1 w-full bg-white relative overflow-hidden"></div>
                ...
                <div className="flex flex-col bg-white border-t border-slate-200 relative">
                    ...
                    <div className="px-5 py-3 flex items-center justify-between h-[60px] bg-white select-none relative z-[120]">
                        <div className="flex items-center gap-4">
                            ...
                            >
                                <svg
                                    className={`transition-colors ${isTerminalOpen ? 'text-[var(--brand)]' : 'group-hover:text-[var(--brand)]'}`}
                                    width="14"
                                    height="14"
                                    viewBox="0 0 24 24"
                                    fill="none"
                                ...
                                Terminal{' '}
                                <span
                                    className={`text-[8px] opacity-60 transition-transform duration-300 ${isTerminalOpen ? 'rotate-180' : ''}`}
                                >
                                    ▲
                                </span>
                            </button>
                                            ...
                                            onClick={async () => {
                                                if (view) {
                                                    if (props.actions?.onSubmit) {
                                                        const result = await props.actions.onSubmit(
            ...
            <style jsx global>{`
                ...
                .cm-cursor {
                    border-left-color: #f77621 !important;
                }
