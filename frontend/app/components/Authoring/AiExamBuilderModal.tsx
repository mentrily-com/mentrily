...
interface AiExamBuilderModalProps {
    ...
    onClose: () => void;
    onGenerateFull: (
        data: { title: string; description: string; sections: any[]; isVisible?: boolean },
        tokenUsage: any,
    ) => void;
}
                            ...
                            {isLoading && (
                                <div className="absolute inset-0 bg-white/80 backdrop-blur-sm z-10 flex flex-col items-center justify-center shrink-0">
                                    ...
                                    <p className="text-xs text-slate-400 font-medium mt-2 max-w-sm text-center">
                                        This may take a minute as we craft a customized, highly-detailed assessment
                                ...
                                <div className="space-y-6 max-w-2xl mx-auto animate-in fade-in zoom-in-95 duration-300">
                                    <div className="text-center mb-8">
                                        ...
                                        <p className="text-slate-500 text-sm mt-2">
                                            Design an exam outline with context-aware AI generation.
                                        </p>
                                    </div>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="p-4 bg-[var(--brand-light)]/20 rounded-2xl border border-[var(--brand-light)]/50 space-y-3">
                                            <div className="flex items-center gap-2 text-[var(--brand-dark)]">
                                                ...
                                                <span className="text-[11px] font-black uppercase tracking-widest">
                                                    Base on Existing Course (Optional)
                                                </span>
                                            </div>
                                            <select
                                            ...
                                            <p className="text-xs text-slate-500 font-medium leading-relaxed">
                                                If selected, the AI will pull the `courseSummary` for this course and
                                                generate questions strictly based on its syllabus.
                                            </p>
                                        </div>
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e) =>
                                                        setConfig({
                                                            ...config,
                                                            numSections: parseInt(e.target.value) || 1,
                                                        })
                                                    }
                                        ...
                                        <div className="space-y-4 mt-6">
                                            <div className="flex items-center justify-between pb-2 border-b border-slate-100">
                                                ...
                                                <span className="text-[10px] font-bold uppercase tracking-widest text-[var(--brand)] bg-[var(--brand-light)]/20 px-2 py-1 rounded-md">
                                                    {config.numSections} Sections Total
                                                </span>
                                            </div>
                                            ...
                                            <div className="space-y-3 max-h-[300px] overflow-y-auto pr-2 no-scrollbar">
                                                {sectionConfigs.map((sec, idx) => (
                                                    <div
                                                        key={idx}
                                                        className="bg-slate-50/50 border border-slate-100 rounded-xl p-4 space-y-4"
                                                    >
                                                        <div className="flex items-center gap-3">
                                                                    ...
                                                                    <button
                                                                        ...
                                                                        onClick={() => {
                                                                            ...
                                                                            if (sec.allowedTypes.includes(type)) {
                                                                                updated[idx].allowedTypes =
                                                                                    sec.allowedTypes.filter(
                                                                                        (t) => t !== type,
                                                                                    );
                                                                            } else {
                                                                                updated[idx].allowedTypes = [
                                    ...
                                    <div className="flex items-center justify-between mb-8">
                                        <div>
                                            ...
                                            <p className="text-slate-500 text-sm mt-1">
                                                Review the proposed structure before we generate the full assessment.
                                            </p>
                                        </div>
                                    </div>
                                            ...
                                            >
                                                ...
                                                <div className="pl-12 space-y-2">
                                                    {section.questions.map((q: any, qIdx: number) => (
                                                        ...
                                                        >
                                                            <span
                                                                className={`px-2 py-0.5 rounded text-[9px] font-black uppercase tracking-widest shrink-0 ${q.type === 'Coding' || q.type === 'Notebook' ? 'bg-indigo-50 text-indigo-600' : 'bg-emerald-50 text-emerald-600'}`}
                                                            >
                                                                {q.type}
                                                            </span>
                                ...
                                <div className="flex flex-col items-center justify-center text-center space-y-6 max-w-md mx-auto h-full animate-in fade-in zoom-in-95 duration-500 pt-10">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-slate-500 text-sm mt-2 font-medium">
                                            Your exam questions have been fully crafted.
                                        </p>
                                    </div>
