    ...
    return (
        <div className="shrink-0 p-3 sm:p-4 bg-white border-t border-slate-100 flex flex-wrap items-center justify-end gap-3 z-10">
            <button
                ...
                className="flex-1 min-h-[40px] px-4 py-2 bg-slate-50 text-slate-500 font-bold rounded-xl text-xs hover:bg-slate-100 transition-all active:scale-95 flex items-center justify-center gap-2 sm:flex-none cursor-pointer"
            >
            ...
            <button
                ...
                className="flex-1 min-h-[40px] px-6 py-2 bg-[var(--brand)] text-white font-bold rounded-xl text-xs hover:bg-[var(--brand-dark)] transition-all active:scale-95 flex items-center justify-center gap-2 shadow-lg shadow-[var(--brand-light)] sm:flex-none cursor-pointer"
            >
                Next
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
