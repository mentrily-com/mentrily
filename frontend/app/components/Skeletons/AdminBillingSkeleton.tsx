/**
 * Purpose-built skeleton for the organization admin billing page
 * (`dashboard/creator/_components/AdminBillingPage.tsx`). It previously fell
 * back to the generic `DashboardSkeleton type="main"` card-list-plus-sidebar
 * shape, which does not resemble this page's header -> current-plan card ->
 * usage-meter grid -> plan-comparison card grid layout at all, so real data
 * popped the whole page into a different shape. Mirrors that real section
 * order and proportions -- including the wider 6-meter usage grid this
 * admin view has (courses/storage/seats/exams plus admin seats and teacher
 * seats, unlike the teacher-facing billing page) -- rather than exact pixel
 * content.
 */
export default function AdminBillingSkeleton() {
    return (
        <div className="font-sans pb-10">
            ...
            {/* Usage overview - admin sees 6 meters, including org seat counts */}
            <section className="bg-white rounded-xl border border-slate-100 shadow-sm p-6 md:p-8 mb-6">
