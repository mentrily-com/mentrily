            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    {isSuperAdminView && (
                        <SettingsSection
                            ...
                            desc="Governance, permissions and state management."
                        >
                                ...
                                <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 flex items-center justify-between">
                                    ...
                                    >
                                        {branding.status === 'Active' ? (
                                            <>
                                                <PauseCircle size={16} /> Pause Org
                                            </>
                                        ) : (
                                            <>
                                                <PlayCircle size={16} /> Activate Org
                                            </>
                                        )}
                                    </button>
                                </div>
                    ...
                    <SettingsSection
                        ...
                        desc="Primary identification for your organization portal."
                    >
                    ...
                    <SettingsSection
                        ...
                        desc="Customize themes and logos to match your brand style."
                    >
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="space-y-4">
                                <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-1">
                    ...
                    <SettingsSection
                        ...
                        desc="Official communication channels and institutional limits."
                    >
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-1.5">
                                <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-1">
                    ...
                    <SettingsSection
                        ...
                        desc="Choose whether teachers can manage upgrades from their own dashboard."
                    >
                        <div className="space-y-4">
                            <PermissionToggle
                                label="Allow Teachers To Manage Their Billing"
                ...
                <div className="space-y-8">
                    <div className="bg-slate-900 rounded-xl p-8 text-white relative overflow-hidden h-fit sticky top-32 shadow-xl">
                        ...
                        <div
                            className="absolute -bottom-10 -right-10 w-48 h-48 rounded-full blur-[60px]"
