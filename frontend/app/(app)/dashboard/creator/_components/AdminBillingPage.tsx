...
export default function AdminBillingPage() {
    const { isAuthorized, isReady } = useRoleGuard(['ADMIN', 'SUPER_ADMIN']);
    ...
    const handlePortal = async () => {
        try {
            posthog.capture('billing_portal_opened', { source: 'creator_billing_admin' });
    ...
    return (
        <div className="animate-fade-in font-sans pb-10">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-8">
                <div>
                    <h1 className="text-2xl font-bold tracking-tight" style={{ color: 'var(--color-text-primary)' }}>Billing & Plans</h1>
            ...
            <section className="bg-white rounded-xl border shadow-sm p-6 md:p-8 mb-6" style={{ borderColor: 'var(--color-border-subtle)' }}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <QuotaBar
                        label="Teacher Seats"
                        used={Number(usageData?.usage?.teacherSeats || 0)}
