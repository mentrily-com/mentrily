export const siteConfig = {
    ...
    domain: process.env.NEXT_PUBLIC_APP_DOMAIN || "blockscode.me",
    description: process.env.NEXT_PUBLIC_APP_DESCRIPTION || "Learn to code with blockscodeX",
    url: process.env.NEXT_PUBLIC_APP_URL || "https://blockscode.me",
    ...
    contactEmail: process.env.NEXT_PUBLIC_CONTACT_EMAIL || "admin@blockscode.me",
