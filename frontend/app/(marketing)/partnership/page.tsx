...
const partnerBenefits = [
    {
        ...
        description: 'Earn a significant percentage of every subscription from schools and institutions you bring to Mentrily.',
        icon: TrendingUp,
        color: '#10B981'
    },
    {
        title: 'Reseller Dashboard',
        description: 'A dedicated portal to manage your leads, track conversions, and monitor your earnings in real-time.',
        icon: Briefcase,
        color: '#008D98'
    },
    {
        title: 'Priority Support',
        description: 'Direct access to our partnership team and technical engineers to help you close deals and support your clients.',
        icon: Users,
        color: '#F59E0B'
    },
    {
        title: 'White-Label Options',
        description: 'Offer Mentrily as your own solution. Custom branding, domains, and certificates for your institutional clients.',
        icon: ShieldCheck,
        color: '#6366F1'
    }
];
...
const partnershipTypes = [
    {
        ...
        description: 'Content creators, bloggers, and influencers who want to promote the best technical education platform to their audience.',
        icon: Zap,
        color: '#EC4899'
    },
    {
        title: 'Institutional Partners',
        description: 'Universities, bootcamps, and government agencies looking for a scalable infrastructure for their technical programs.',
        icon: Scale,
        color: '#8B5CF6'
    },
    {
        title: 'Global Resellers',
        description: 'Established software vendors and consultants who want to add Mentrily to their product portfolio.',
        icon: Globe,
        color: '#3B82F6'
    },
    {
        title: 'Integration Partners',
        description: 'LMS providers and HR tech companies looking to integrate Mentrily’s coding playground into their own products.',
        icon: Handshake,
        color: '#14B8A6'
    }
];
...
function SectionTitle({ title, subtitle }: { title: string, subtitle?: string }) {
    ...
    return (
        ...
        >
            <h2 className="text-3xl sm:text-4xl font-display text-slate-900 mb-4" style={{ fontFamily: 'var(--font-display)' }}>
                {title}
            </h2>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        ...
                        <p
                            className="mt-6 text-lg sm:text-xl text-slate-600 max-w-xl leading-relaxed mb-10"
                        >
                            Join our partnership program and help schools worldwide deliver world-class technical education. Earn recurring commissions and get exclusive support.
                        </p>
                        ...
                        <div className="relative w-full max-w-[480px] aspect-[4/3]">
                            ...
                            >
                                ...
                                <div className="relative z-10">
                                    <p className="text-teal-400 text-xs font-bold uppercase tracking-widest mb-2">Revenue Growth</p>
                            ...
                            >
                                <div className="flex justify-between items-start">
                                    ...
                                    <div className="px-4 py-1.5 rounded-full bg-teal-50 border border-teal-100 flex items-center gap-2">
                                        ...
                                        <span className="text-[10px] font-bold text-teal-700 uppercase tracking-wider">Verified Program</span>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p className="text-slate-500 text-sm leading-relaxed mb-6">
                                        You are officially authorized to distribute Mentrily licenses and provide implementation services.
                                    </p>
                                        ...
                                        <div className="flex -space-x-2">
                                            {[1,2,3].map(i => (
                                                <div key={i} className="w-8 h-8 rounded-full border-2 border-white bg-slate-100 overflow-hidden">
                                                    <img src={`https://api.dicebear.com/7.x/avataaars/svg?seed=${i + 10}`} alt="Partner" />
                                                </div>
                                            ))}
            ...
            <section className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <motion.div
                        ...
                        transition={{ duration: 0.6 }}
                    >
                        <h2 className="text-3xl sm:text-4xl font-display text-slate-900 mb-6" style={{ fontFamily: 'var(--font-display)' }}>
                            Scale your business with Mentrily
                        </h2>
                        <p className="text-slate-600 mb-8 leading-relaxed">
                            Our program is designed for companies that want to offer a complete technical education solution. Whether you are an educational consultant or a software vendor, Mentrily fits perfectly into your portfolio.
                        </p>
                    ...
                    >
                        <div className="grid grid-cols-2 gap-8">
                            <div className="p-6 rounded-2xl bg-white shadow-sm">
                                <p className="text-[10px] font-bold text-teal-600 uppercase tracking-widest mb-2">Success Rate</p>
                                <p className="text-3xl font-bold text-slate-900">98%</p>
                                <p className="text-xs text-slate-500 mt-1">Client retention</p>
                            </div>
                            <div className="p-6 rounded-2xl bg-white shadow-sm">
                                <p className="text-[10px] font-bold text-teal-600 uppercase tracking-widest mb-2">Onboarding</p>
                            ...
                            <div className="col-span-2 p-6 rounded-2xl bg-white shadow-sm flex items-center justify-between">
                                <div>
                                    <p className="text-[10px] font-bold text-teal-600 uppercase tracking-widest mb-2">Global Support</p>
