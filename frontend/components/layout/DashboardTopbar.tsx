            ...
            >
                ...
                <div className="flex shrink-0 items-center gap-2 sm:gap-3">
                    ...
                    <div ref={profileRef} className="relative flex items-center gap-2.5">
                        ...
                        <button
                            onClick={() => setProfileOpen(!profileOpen)}
                            className="hidden sm:flex w-5 h-5 items-center justify-center cursor-pointer focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-[var(--brand,#008D98)] rounded"
