            ...
            >
                <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
                    ...
                    <button
                        ...
                        className="md:hidden p-2 rounded-lg cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400"
                        style={{ color: '#0F172A' }}
                    ...
                    >
                        <div className="flex items-center justify-between px-4 h-16">
                            ...
                            <button
                                ...
                                className="p-2 rounded-lg cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400"
                                style={{ color: '#0F172A' }}
